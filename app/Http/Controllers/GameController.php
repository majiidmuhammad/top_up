...
class GameController extends Controller
{
    ...
    {
        $coin = Game::where('nama_game', 'Mobile Legends')->get();
        return view('game.mobileLegend', [
            'judul' => 'Mobile Legend',
            'coin' => $coin
        ]);
    }
    ...
    {
        $coin = Game::where('nama_game', 'PUBG')->get();
        return view('game.pubg', [
            'judul' => 'PUBG',
            'coin' => $coin
        ]);
    }
    ...
    public function buyMobileLegend(Request $request)
    {
            // Validasi data form
            $validated = $request->validate([
            'akun_game' => 'required|string',
    ...
    public function buyPubg(Request $request)
    {
            // Validasi data form
            $validated = $request->validate([
            'akun_game' => 'required|string',
