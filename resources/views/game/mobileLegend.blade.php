...
<div class="container">
    <div class="d-flex align-items-center mb-5 gap-3">
        ...
        <h1 class="fs-1">Mobile Legend</h1>
    </div>
    <form role="form" method="POST" action="{{ route('buyMobile-Legend') }}">
        @csrf
        <div>
            <label for="akun_game">Masukkan user ID dan zone ID anda</label>
            <input type="text" id="akun_game" name="akun_game" placeholder="Masukkan ID dan zone ID 'user ID(Zone ID)'">
        </div>
